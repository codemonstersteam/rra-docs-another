...
// ParseArgs — ингресс-адаптер слайса fitness: только парсинг флагов и
// позиционного аргумента. args — os.Args[2:] (после "fitness").
func ParseArgs(args []string, stderr io.Writer) (domain.Request, error) {
	...
	llmProvider := fs.String("llm-provider", "", "LLM-провайдер: anthropic|openai")
	llmBaseURL := fs.String("llm-base-url", "", "base-url OpenAI-совместимого эндпоинта")
	llmModel := fs.String("llm-model", "", "имя модели")
