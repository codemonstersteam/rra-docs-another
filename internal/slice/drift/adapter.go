...
// ParseArgs — ингресс-адаптер слайса drift: только парсинг флагов и позиционного
// аргумента. args — os.Args[2:] (после имени подкоманды "drift").
func ParseArgs(args []string, stderr io.Writer) (domain.Request, error) {
	...
	semantic := fs.Bool("semantic", false, "включить семантический тир L6c (требует LLM)")
