...
Часть продукта **[Rational Repository Auditor (RRA)](https://github.com/codemonstersteam/rra)**, но позиционируется как
...
| — (формат вывода) | `format_invalid` | 2 | задать `--format json` или `md` |
| `ReportSink` (вывод) | `report_write_failed` | 2 | проверить путь `--out` и права записи |
