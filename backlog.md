...
**#1, #2 закрыты (PR #15)**, **T1 (#5, частично) — PR #19** (doc_drift 194→152).
**Остаётся:** **T1b** — якорь claim-путей к структуре репо (остаток #5: import-path/
MIME/ветки/внешние repo всё ещё ложно матчатся) — **приоритетным PR**; затем #3 и #4
(чистка/UX) — отдельным PR ниже.
...
#### E16-T1b — fix: якорь claim-путей к структуре репо (остаток #5) · приоритет
