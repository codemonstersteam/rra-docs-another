...
description: Генерация компонентных тестов для программы — сетевого сервиса (OpenAPI/AsyncAPI) или CLI-инструмента (api-specification/cli.md + report.schema.json) — как чёрного ящика. Применять, когда нужно создать или дополнить .feature файлы в директории component-tests на основе контракта. Не применять для юнит-тестов или контрактных тестов между сервисами.
---
